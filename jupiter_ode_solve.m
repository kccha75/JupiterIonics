clear;clc;close all
global N2_b HA_b Li_b kap kan k1 k2 kh F R T alpha E0 k0 E j

% Solves system of ODEs reflecting chemical equations (SEE WHITEBOARD)
...
E=@(t) abs(t-50)/50+3;%E=@(t) (-abs(t-50)/50+1)*4;
...
% Plots vs time
figure('Position',[200 300 600 900]); fsz=15; lw=2;
...
ylabel('$Li^+_{ads}$','interpreter','latex','fontsize',fsz)

subplot(5,2,5)
plot(t,y(:,3),'linewidth',lw)
ylabel('$Li^0_{ads}$','interpreter','latex','fontsize',fsz)

subplot(5,2,6)
plot(t,y(:,4),'linewidth',lw)
ylabel('$Li_3N$','interpreter','latex','fontsize',fsz)

subplot(5,2,7)
plot(t,y(:,5),'linewidth',lw)
ylabel('$N_2$','interpreter','latex','fontsize',fsz)

subplot(5,2,8)
plot(t,y(:,6),'linewidth',lw)
ylabel('$HA$','interpreter','latex','fontsize',fsz)

subplot(5,2,9)
plot(t,y(:,7),'linewidth',lw)
ylabel('$Li^+$','interpreter','latex','fontsize',fsz)
xlabel('$t$','interpreter','latex','fontsize',fsz)

subplot(5,2,10)
plot(t,y(:,8),'linewidth',lw)
ylabel('$NH_3$','interpreter','latex','fontsize',fsz)
xlabel('$t$','interpreter','latex','fontsize',fsz)
